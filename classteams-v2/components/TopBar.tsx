    ...
    <header className="flex items-center justify-between px-8 py-4 w-full bg-white border-b border-outline/30 sticky top-0 z-40">
      <div className="flex items-center gap-12">
        ...
        <form className="relative w-64" role="search">
          ...
          <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-sm pointer-events-none" aria-hidden="true">
            search
          </span>
          <input
            id="search-input"
      ...
      <nav aria-label="User actions" className="flex items-center gap-6">
        <button className="text-slate-500 hover:text-primary transition-colors" aria-label="Notifications">
          <span className="material-symbols-outlined" aria-hidden="true">notifications</span>
        </button>
        <button className="text-slate-500 hover:text-primary transition-colors" aria-label="Profile">
